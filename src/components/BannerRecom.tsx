    ...
    return (
        <div className="flex  justify-between bg-white rounded-3xl mt-9 px-8 py-5">
            <div className="flex flex-col max-w-[392px] w-full">
                ...
                <button onClick={() => window.location.href = "/catalog"} className="text-white px-16 py-4 text-[1rem] font-bold bg-[#1F1F1F] rounded-[2.25rem] mt-28 cursor-pointer hover:bg-[#00D414] duration-150">Смотреть каталог</button>
            </div>
